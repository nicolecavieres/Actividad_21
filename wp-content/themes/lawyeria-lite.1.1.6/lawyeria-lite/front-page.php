			 ...
			 ?>');">
				<div class="subheader-color cf">
					<div class="wrapper cf">
						<div class="full-header-content full-header-content-no-sidebar">
								...
								<?php
									if ( get_theme_mod( 'lawyeria_lite_frontpage_header_title','Titulo cambiado para actividad 20.' ) ) {
										echo '<h3>';
										echo get_theme_mod( 'lawyeria_lite_frontpage_header_title','Titulo cambiado para actividad 20.' );
										echo '</h3>';
									}
								?>
				...
				<div class="second-subheader">
					<div class="wrapper">
						<h3>
							<?php
								if ( get_theme_mod( 'lawyeria_lite_frontpage_subheader_title','Cambio de texto, desde front-page.php' ) ) {
									echo get_theme_mod( 'lawyeria_lite_frontpage_subheader_title','Cambio de texto, desde front-page.php' );
								}
							?>
						</h3><!--/h3-->
					</div><!--/div .wrapper-->
